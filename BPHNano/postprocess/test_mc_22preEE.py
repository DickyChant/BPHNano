...
# with command line options: RECO --conditions 130X_mcRun3_2022_realistic_v5 --datatier NANOAOD --era Run3 --eventcontent NANOAODSIM --filein filein.root --fileout file:test_mc.root --nThreads 4 -n 1000 --no_exec --python_filename test_mc_22preEE.py --scenario pp --step NANO --mc
