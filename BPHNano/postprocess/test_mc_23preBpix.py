...
# with command line options: RECO --conditions 130X_mcRun3_2023_realistic_v15 --datatier NANOAOD --era Run3_2023 --eventcontent NANOAODSIM --filein filein.root --fileout file:test_mc.root --nThreads 4 -n 1000 --no_exec --python_filename test_mc_23preBpix.py --scenario pp --step NANO --mc
