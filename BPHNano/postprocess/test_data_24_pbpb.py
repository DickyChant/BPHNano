...
# with command line options: RECO --conditions auto:run3_data_prompt --datatier NANOAOD --era Run3,run3_nanoAOD_124 --eventcontent NANOAOD --filein filein.root --fileout file:test_data.root --nThreads 4 -n 10000 --no_exec --python_filename test_data_22.py --scenario pp --step NANO
...
process = cms.Process('NANO',Run3_pp_on_PbPb_2024)
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:/eos/cms/store/group/phys_heavyions/wangj/RECO2024/miniaod_PhysicsHIPhysicsRawPrime0_388056_ZB.root'),
